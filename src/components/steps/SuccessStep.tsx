    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-24 h-24 rounded-full bg-linear-to-br from-green-400 to-green-600 flex items-center justify-center mb-8 shadow-lg shadow-green-500/30"
            >
                <motion.svg
            ...
            <motion.div
                ...
                className="mt-12 relative flex items-center justify-center gap-1"
            >
                <div
                    className="relative"
                ...
                >
                    <span className="text-gray-400 text-sm cursor-pointer hover:text-gray-600 transition-colors">
                        Made by <span className="font-semibold">anant_hq</span>
                    </span>
                    ...
                    <AnimatePresence>
                        {showSocialTooltip && (
                            <motion.div
                                ...
                                className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-4 py-3 bg-white rounded-xl shadow-xl border border-gray-100 flex gap-4 z-50 whitespace-nowrap"
                            >
                                <a
